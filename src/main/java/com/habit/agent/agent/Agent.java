...
/**
 * AI 代理接口，定义处理聊天事件与会话的核心能力。
 *
 * <p>参照示例 {@code com.tianji.aigc.agent.Agent} 设计，作为多 Agent 体系的基础契约：
 * 各职能 Agent（健康助手、知识讲解等）均实现该接口，由 {@link AbstractAgent} 提供公共实现。</p>
 */
public interface Agent {
     ...
     * 获取智能体类型标识。
     *
     * @return 代理类型枚举值（如：HEALTH、KNOWLEDGE 等）
     */
    ...
    /**
     * 获取系统提示信息模板的参数，默认为空 Map，子类可以覆盖重写该方法以返回自定义的系统提示信息参数。
     */
