...
/**
 * 运动建议子智能体（{@code EXERCISE}）。
 *
 * <p>聚焦运动维度的健康建议：复用基类 RAG 检索增强获取科普支撑，
 * 挂载打卡/目标/提醒/日期工具以查询、记录运动数据并协助设定运动提醒，
 * 由系统提示词约束模型仅处理运动维度。其余能力继承自 {@link AbstractAgent}。</p>
 */
@Component
public class ExerciseAgent extends AbstractAgent {
    ...
    public ExerciseAgent(ChatSessionService chatSessionService,
    ...
    @Override
    public Object[] tools() {
        return new Object[]{habitTools, goalTools, reminderTools, commonTools};
    }
