 ...
 * 会话 ID 经响应头 {@code X-Session-Id} 下发（PRD 1.4）。</p>
 */
@Slf4j
@RestController
...
public class ChatController {
     ...
     */
    @Operation(summary = "流式对话", description = "以 SSE 流式返回 Agent 回答，会话 ID 经 X-Session-Id 响应头下发")
     ...
     */
    @Operation(summary = "停止生成", description = "终止指定会话正在进行的流式回答")
    @PostMapping("/stop")
    public void stop(@Parameter(description = "会话ID", example = "c8f0e1a2-3b4d-4e5f")
